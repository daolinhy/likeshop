    ...
    public static function getMenuContent($scene = true,$from = true){
        ...
        $config1 = [
            ...
            self::index_coupon_list        => [
                'name'          => '领券中心',
                'link'          => '/bundle2/pages/user_getcoupon/user_getcoupon',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            ...
            self::index_my_collect         => [
                'name'          => '我的收藏',
                'link'          => '/bundle2/pages/user_collection/user_collection',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_store_news         => [
                'name'          => '商城资讯',
                'link'          => '/bundle2/pages/news_list/news_list',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_store_help         => [
                'name'          => '帮助中心',
                'link'          => '/bundle2/pages/news_list/news_list?type=1',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
            self::index_delivery_address   => [
                'name'          => '收货地址',
                'link'          => '/bundle2/pages/user_address/user_address',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
        ...
        $config2 = [
            ...
            self::centre_my_coupon         => [
                'name'          => '我的优惠券',
                'link'          => '/bundle2/pages/user_coupon/user_coupon',
                'is_tab'        => 0,
                'link_type'     => 1,
                'menu_type'     => 1,
            ],
