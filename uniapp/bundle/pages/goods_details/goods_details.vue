	...
	<view class="goods-details">
		...
		<view class="contain" v-if="!isNull">
			...
			<view class="evaluation bg-white mt20">
				<navigator hover-class="none" :url="'/bundle2/pages/all_comments/all_comments?id=' + goodsDetail.id"
	...
	export default {
		...
		methods: {
			...
			onBuy(e) {
				...
				uni.navigateTo({
					url: '/bundle2/pages/confirm_order/confirm_order?data=' + encodeURIComponent((JSON.stringify(params)))
				})
				console.log(1111)
			},
			onConfirm(e) {
